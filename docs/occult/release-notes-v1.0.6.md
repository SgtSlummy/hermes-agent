...
after rebuilding a hash-locked reference environment. Package bytes and
metadata, reproducible bytecode, launchers, and Council binaries must match
authenticated release bytes. An identical rerun does not replace the active
commands or receipt.
